		  ...
		  <table class="list">
			...
			<tbody>
			  ...
			  <tr>
				...
				<td class="right"><a class="vremenno" href="<?php echo $product['return']; ?>"><img src="catalog/view/theme/default/image/return.png" alt="<?php echo $button_return; ?>" title="<?php echo $button_return; ?>" /></a></td>
			  </tr>
			  <?php } ?>
