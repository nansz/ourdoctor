...
.simpleregister-button-block .btn {
	background:#f49c01;
	color:#fff;
}
.simpleregister-button-block .btn:hover {
	background:#fff;
	color:#f49c01;
}
...
.simplecheckout-customer-right, .simplecheckout-customer-right input[type=text] {
	width:100%;
}
</style>
            ...
            <?php } ?>
                ...
                <table class="simplecheckout-customer">
                    <?php foreach ($customer_fields as $field) { ?>
                        ...
                        <?php } else { ?>
                            <tr>
                                <td style="display:none;" class="simplecheckout-customer-left">
