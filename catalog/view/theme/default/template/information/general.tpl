...
<div class="breadcrumbs-box container">
	<div class="row">
		<ul class="breadcrumbs start">
			...
			<li><span><?php translate('Общие публикации', 'Загальні публікації', 'General Publications'); ?></span></li>
		</ul>
	</div>
</div>
<div class="container general-page" itemscope itemtype="http://mdclux.com.ua/general/">
				<div class="row center column">
					<h1 class="title" itemprop="name"><?php translate('Общие публикации', 'Загальні публікації', 'General Publications'); ?></h1>
							...
							<div class="section-wrap">
								<div class="section-container">
									<div class="section__content">
										<div class="blog">
											<?php foreach ($general_data as $articles) { ?>
											<div class="blog__item">
												<a itemprop="url" href="<?php echo $articles['href']; ?>" class="blog-link has-img">
													<img itemprop="image" src="<?php echo $articles['image']; ?>"
...
<path d="M0.0253906 6.77755C0.0253906 5.2778 1.24118 4.06201 2.74093 4.06201C4.24068 4.06201 5.45647 5.2778 5.45647 6.77755V7.08678H0.0253906V6.77755Z"
	  fill="#C4C4C4"/>
                                             ...
                                             <?php echo $articles['author']; ?>
													...
													<a itemprop="url" href="<?php echo $articles['href']; ?>"
													   class="blog-title"><?php echo $articles['title']; ?></a>
													<p class="blog-preview" itemprop="description" >
...
<path d="M1.06384 0.770508L4.99316 4.69983L1.06384 8.62915" stroke="#006A86"/>
										...
										<div class="blog-nav">
											...
											<div  itemprop="pagination" class="box-pagination">
												<?php echo $pagination; ?>
											</div>
										</div>
									</div>
...
<?php if(isset($general_info)) { ?>
<div class="breadcrumbs-box container">
	<div class="row">
		<ul class="breadcrumbs start">
			<li><a href="/"><?php translate('Мдц-lux', 'Мдц-lux', 'Mdc-lux'); ?></a></li>
			<li><a href="/general/"><?php translate('Общие публикации', 'Загальні публікації', 'General Publications'); ?></a></li>
