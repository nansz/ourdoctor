<?php echo $header; ?>
	...
	<?php if (isset($sterminyorthopedics_data)) { ?>	
<div class="breadcrumbs-box container">
	<div class="row">
		<ul class="breadcrumbs start">
			...
			<li><span><?php translate('Термины ортопедии', 'Терміни ортопедії', 'Terms of orthopedics'); ?></span></li>
		</ul>
	</div>
</div>
<div class="container science-page">
				<div class="row center column">
					<h1 class="title"><?php translate('Термины ортопедии', 'Терміни ортопедії', 'Terms of orthopedics'); ?></h1>
					<div class="science-wrapper">
					<?php foreach ($sterminyorthopedics_data as $sterminyorthopedics) { ?>
						<div class="science-box col-md-12">
							<div class="col-md-3 science-img">
								<div class="row">
									<a href="<?php echo $sterminyorthopedics['href']; ?>"><img src="<?php echo $sterminyorthopedics['image']; ?>" alt="<?php echo $sterminyorthopedics['title']; ?>"></a>
								</div>
							</div>
							<div class="col-md-9 science-text">
								<div class="row">
									<div class="science-title hh2"><a href="<?php echo $sterminyorthopedics['href']; ?>"><?php echo $sterminyorthopedics['title']; ?></a></div>
									<p class="science-desc"><?php echo $sterminyorthopedics['description']; ?></p>
									<div class="btw date-link">
										<span><?php echo $sterminyorthopedics['posted']; ?></span>
										<a href="<?php echo $sterminyorthopedics['href']; ?>"><?php translate('Подробнее', 'Детальніше', 'Learn More'); ?><img src="/img/next.svg" alt=""></a>
									</div>
								</div>
							</div>
						</div>
...
<?php if(isset($sterminyorthopedics_info)) { ?>
		<div class="breadcrumbs-box container">
	<div class="row">
		<ul class="breadcrumbs start">
			<li><a href="/">Мдц-lux</a></li>
			<li><a href="/orthopedics/"><?php translate('Ортопедия', 'Ортопедія', 'Orthopedics'); ?></a></li>
			<li><a href="/terminy-orthopedics/"><?php translate('Термины ортопедии', 'Терміни ортопедії', 'Terms of orthopedics'); ?></a></li>
