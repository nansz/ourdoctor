...
<?php if (isset($science_data)) { ?>
<div class="breadcrumbs-box container">
	<div class="row">
		<ul class="breadcrumbs start">
			<li><a href="/"><?php translate('Мдц-lux', 'Мдц-lux', 'Mdc-lux'); ?></a></li>
			<li><span><?php translate('Научные публикации', 'Наукові публікації', 'Science publications'); ?></span></li>
		</ul>
	</div>
</div>
</div>
<div class="container general-page">
	<div class="row center column">
		<h1 class="title"><?php translate('Научные публикации', 'Наукові публікації', 'Science publications'); ?></h1>
				...
				<div class="section-wrap">
					<div class="section-container">
						<div class="section__content">
							<div class="blog">
								<?php foreach ($science_data as $articles) { ?>
...
<path d="M1.06384 0.770508L4.99316 4.69983L1.06384 8.62915" stroke="#006A86"/>
								...
								<?php } ?>
								<div id="ajax_loader" class="blog__item"></div>
							</div>
							<!-- navigation -->
							<div class="blog-nav">
...
<?php if(isset($science_info)) { ?>
<div class="breadcrumbs-box container">
	<div class="row">
		<ul class="breadcrumbs start">
				<li><a href="/"><?php translate('Мдц-lux', 'Мдц-lux', 'Mdc-lux'); ?></a></li>
				<li><a href="/science/"><?php translate('Научные публикации', 'Наукові публікації', 'Science publications'); ?></a></li>
