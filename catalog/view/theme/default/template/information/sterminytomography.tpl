<?php echo $header; ?>
	...
	<?php if (isset($sterminytomography_data)) { ?>	
<div class="breadcrumbs-box container">
	<div class="row">
		<ul class="breadcrumbs start">
			...
			<li><span><?php translate('Термины томографии', 'Терміни томографії', 'Terms of tomography'); ?></span></li>
		</ul>
	</div>
</div>
<div class="container science-page">
				<div class="row center column">
					<h1 class="title"><?php translate('Термины томографии', 'Терміни томографії', 'Terms of tomography'); ?></h1>
					<div class="science-wrapper">
					<?php foreach ($sterminytomography_data as $sterminytomography) { ?>
						<div class="science-box col-md-12">
							<div class="col-md-3 science-img">
								<div class="row">
									<a href="<?php echo $sterminytomography['href']; ?>"><img src="<?php echo $sterminytomography['image']; ?>" alt="<?php echo $sterminytomography['title']; ?>"></a>
								</div>
							</div>
							<div class="col-md-9 science-text">
								<div class="row">
									<div class="science-title hh2"><a href="<?php echo $sterminytomography['href']; ?>"><?php echo $sterminytomography['title']; ?></a></div>
									<p class="science-desc"><?php echo $sterminytomography['description']; ?></p>
									<div class="btw date-link">
										<span><?php echo $sterminytomography['posted']; ?></span>
										<a href="<?php echo $sterminytomography['href']; ?>"><?php translate('Подробнее', 'Детальніше', 'Learn More'); ?><img src="/img/next.svg" alt=""></a>
									</div>
								</div>
							</div>
						</div>
...
<?php if(isset($sterminytomography_info)) { ?>
	...
	<div class="row">
		<ul class="breadcrumbs start">
			<li><a href="/"><?php translate('Мдц-lux', 'Мдц-lux', 'Mdc-lux'); ?></a></li>
			<li><a href="/tomography/"><?php translate('Томография', 'Томографія', 'Tomography'); ?></a></li>
			<li><a href="/terminy-tomography/"><?php translate('Термины томографии', 'Терміни томографії', 'Terms of tomography'); ?></a></li>
