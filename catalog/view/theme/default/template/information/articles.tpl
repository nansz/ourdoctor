...
<div class="breadcrumbs-box container">
    <div class="row">
        <ul class="breadcrumbs start">
            ...
            <li><span><?php translate('Новости', 'Новини', 'News'); ?></span></li>
        </ul>
    </div>
</div>
<div class="container news-page">
    <div class="row center column">
        <h1 class="title"><?php translate('Новости', 'Новини', 'News'); ?></h1>
...
<div class="breadcrumbs-box container">
    <div class="row">
        <ul class="breadcrumbs start">
            <li><a href="/"><?php translate('Мдц-lux', 'Мдц-lux', 'Mdc-lux'); ?></a></li>
            <li><a href="/news/"><?php translate('Новости', 'Новини', 'News'); ?></a></li>
