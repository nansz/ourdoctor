...
<div class="breadcrumbs-box container">
    <div class="row">
        <ul class="breadcrumbs start">
            ...
            <li><span><?php translate('Медицинские кейсы', 'Медичні кейси', 'Medical Cases'); ?></span></li>
        </ul>
    </div>
</div>
<div class="container medicalcases-page">
    <div class="row center column">
        <h1 class="title"><?php translate('Медицинские кейсы', 'Медичні кейси', 'Medical Cases'); ?></h1>
...
<div class="breadcrumbs-box container">
    <div class="row">
        <ul class="breadcrumbs start">
            <li><a href="/"><?php translate('Мдц-lux', 'Мдц-lux', 'Mdc-lux'); ?></a></li>
            <li><a href="/medicalcases/"><?php translate('Медицинские кейсы', 'Медичні кейси', 'Medical Cases'); ?></a></li>
