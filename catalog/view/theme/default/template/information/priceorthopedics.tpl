...
<div class="breadcrumbs-box container">
	<div class="row">
		<ul class="breadcrumbs start">
			...
			<li><h1 style="color:#006a86;font-size:16px;"><?php translate('Прайс-лист', 'Прайс-лист', 'Price list'); ?> <?php translate('Ортопедия', 'Ортопедія', 'Orthopedics'); ?></h1></li>
		</ul>
	</div>
</div>
<div class="container price-block">
	<div class="row">
		<div class="price-navigation center">
			...
			<h2 class="price-title active center"><a href="/price-orthopedics/"><img src="/img/spine-white.svg" alt="" class="icon"><?php translate('Ортопедия', 'Ортопедія', 'Orthopaedics'); ?></a></h2>
