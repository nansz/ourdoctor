...
<div class="breadcrumbs-box container">
    <div class="row">
        <ul class="breadcrumbs start">
            ...
            <li><span><?php translate('Новости медицины', 'Новини медицини', 'Medicine news'); ?></span></li>
        </ul>
    </div>
</div>
<div class="container medicinenews-page">
    <div class="row center column">
        <h1 class="title"><?php translate('Новости медицины', 'Новини медицини', 'Medicine news'); ?></h1>
...
<div class="breadcrumbs-box container">
    <div class="row">
        <ul class="breadcrumbs start">
            <li><a href="/"><?php translate('Мдц-lux', 'Мдц-lux', 'Mdc-lux'); ?></a></li>
            <li><a href="/medicinenews/"><?php translate('Новости медицины', 'Новини медицини', 'Medicine news'); ?></a></li>
