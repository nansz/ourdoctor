...
<div class="breadcrumbs-box container">
	<div class="row">
		<ul class="breadcrumbs start">
			...
			<li><span><?php translate('Акции', 'Акції', 'Promotions'); ?></span></li>
		</ul>
	</div>
</div>
<div class="container sale-page">
				<div class="row center column">
					<h1 style="color:#006a86;"><?php echo $heading_title; ?></h1>
					<div class="sale-wrapper">
					<?php foreach ($sale_data as $sale) { ?>
						<div class="sale-box col-md-12">
							<div class="col-md-3 sale-img">
								<div class="row">
									<a href="<?php echo $sale['href']; ?>"><img src="<?php echo $sale['image']; ?>" alt="<?php echo $sale['title']; ?>"></a>
								</div>
							</div>
							<div class="col-md-9 sale-text">
								<div class="row">
									<div class="sale-title hh2"><a href="<?php echo $sale['href']; ?>"><?php echo $sale['title']; ?></a></div>
									<p class="sale-desc"><?php echo $sale['description']; ?></p>
									<div class="btw date-link">
										<span><?php echo $sale['posted']; ?></span>
										<a href="<?php echo $sale['href']; ?>"><?php translate('Подробнее', 'Детальніше', 'Learn More'); ?><img src="/img/next.svg" alt=""></a>
									</div>
								</div>
							</div>
						</div>
...
<?php if(isset($sale_info)) { ?>
<div class="breadcrumbs-box container">
	<div class="row">
		<ul class="breadcrumbs start">
			<li><a href="/"><?php translate('Мдц-lux', 'Мдц-lux', 'Mdc-lux'); ?></a></li>
			<li><a href="/sale/"><?php translate('Акции', 'Акції', 'Promotions'); ?></a></li>
