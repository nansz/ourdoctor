...
<div id="myModal" class="bt_modal byclick" style="top: 45%; width: 535px;" >
...
<script type="text/javascript">
	...
	$(document).ready(function(){	
		$("#user_phone").mask('<?php echo $field_user_phone_maskedinput; ?>');	
	});
...
<script>
	$(document).ready(function(){	
		$("#user_phone").mask('+38 (099) 999-99-99<?php //echo $field_user_phone_maskedinput; ?>');	
	});
</script>