...
<div class="breadcrumbs-box container">
	<div class="row">
		<ul class="breadcrumbs start">
			...
			<?php if($cat=='Томография' or $cat=='Томографія') { ?>
			<li><a href="/tomography/"><?php translate('Томография', 'Томографія', ''); ?></a></li>
			<li><a href="/price-tomography/">Прайс-лист</a></li>
			<?php } 
			else if($cat=='Ортопедия' or $cat=='Ортопедія') { ?>
			<li><a href="/orthopedics/"><?php translate('Ортопедия', 'Ортопедія', ''); ?></a></li>
			<li><a href="/price-orthopedics/">Прайс-лист</a></li>
			<?php } ?>
			<li><span><?php echo $heading_title; ?></span></li>
		</ul>
	</div>
</div>
<div class="modal" id="appointmentsa">
  <div class="modal-sandbox"></div>
  <div class="modal-box">
    <div class="modal-header">
      <div class="hh1"><?php translate('Записаться на прием', 'Записатися на прийом', 'Make an appointment'); ?></div>
    </div>
    ...
    <div class="modal-body">
      <form action="/index.php?route=common/footer/appointment" class="center column" data-autosubmit="true">
        ...
        <input type="text" name="name" placeholder="<?php translate('Введите имя', 'Введіть ім`я', ''); ?>">
        <label>Телефон*</label>
        <input type="text" name="phone" id="phone" placeholder="+38(___) ___-__-__">
        <p><?php translate('Пример', 'Приклад', 'Phone'); ?>: +38 (095) 449 76 28</p>
        <label><?php translate('Услуга', 'Послуга', ''); ?>*</label>
        <input name="services" type="text" value="<?php echo $heading_title; ?>" id="toservices">
        <label style="display:none;"><?php translate('Область исследования', 'Область дослідження', ''); ?></label>
        <input type="hidden" name="science">
        <label><?php translate('Укажите удобное для Вас время', 'Укажіть зручний для Вас час', ''); ?>*</label>
        ...
        <input type="text" name="captcha" id="captcha" placeholder="<?php translate('Введите проверочный код', 'Введіть код перевірки', ''); ?>">
...
<div class="container page">
	<div class="row has-orders">
		<div class="col-md-3 col-sm-3 page-img center column">
			...
			<span><?php translate('Поделиться', 'Поділитись', ''); ?></span>
...
<path d="M18.5156 1.88796C17.8531 2.16521 17.1422 2.35323 16.3954 2.43718C17.158 2.00587 17.7417 1.32176 18.0184 0.509095C17.3031 0.908512 16.5134 1.19854 15.6721 1.35576C14.9984 0.676956 14.04 0.25415 12.9771 0.25415C10.9379 0.25415 9.28442 1.81573 9.28442 3.74062C9.28442 4.01362 9.31704 4.28026 9.38004 4.53523C6.31162 4.38968 3.59077 3.00126 1.76974 0.891512C1.45142 1.40568 1.27033 2.00479 1.27033 2.64432C1.27033 3.85429 1.92271 4.9219 2.91254 5.54651C2.30739 5.5274 1.73824 5.37018 1.23998 5.10885V5.1524C1.23998 6.84146 2.51324 8.25112 4.20154 8.57196C3.89221 8.65057 3.56604 8.69412 3.2286 8.69412C2.99015 8.69412 2.75957 8.67182 2.53348 8.62932C3.00363 10.0156 4.36689 11.0237 5.9821 11.0514C4.71895 11.9862 3.12624 12.5418 1.39633 12.5418C1.09827 12.5418 0.804684 12.5248 0.515625 12.494C2.14995 13.4851 4.09021 14.063 6.17557 14.063C12.9682 14.063 16.6811 8.74937 16.6811 4.14112L16.6687 3.68965C17.3942 3.20096 18.0218 2.58696 18.5156 1.88796Z"
	  fill="#006A86"/>
				...
				<div class="product-form">
					<p class="title"><?php translate('Записаться на прием', 'Записатися на прийом', 'Make an appointment'); ?></p>
					<form action="/index.php?route=common/footer/appointment" class="center column" data-autosubmit="true">
						<label><?php translate('Имя', 'Ім`я', 'Name'); ?>*</label>
						<input type="text" name="name" placeholder="<?php translate('Введите имя', 'Введіть ім`я', ''); ?>">
						<label>Телефон*</label>
