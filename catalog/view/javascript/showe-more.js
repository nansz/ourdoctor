    ...
    $.ajax({
        ...
        success:function (data) {
            ...
            if ($data) {
                ...
                $('.box-pagination').html($data.find('.pagination')); /*показывает на какой мы странице в пагинации. обращаемся к классу который стоит выше над классом пагинации ( можно конечно и на сам клас погинации обращаться но тогда он делает копию самого себя) */
...
$(document).ready(function(){
    ...
    var text=$('#swovs').val();
    // var text="<?php translate('Показать больше', 'Показати більше', 'Show more'); ?>";
    console.log(text);
    var button_more_block ="<button  type=\"button\" class=\"load_more more-btn\" >"+text+"</button>\n";
