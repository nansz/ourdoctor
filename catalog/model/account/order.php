...
class ModelAccountOrder extends Model {
	...
	public function getTotalOrderProductsCountByOrderId($order_id) {
        ...
        public function getMedicalRecord($customer_id) {
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "medical_record WHERE customer_id = '" . (int)$customer_id . "'");

        return $query->rows;
    }

    public function getCaseHistory($medical_record) {
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "case_history WHERE medical_record_id = '" . (int)$medical_record . "'");
