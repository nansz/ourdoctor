...
$_['heading_titles'] = 'Контакти | Медичний центр: адреса, карта проїзду | МДЦ LUX'; #39743
$_['heading_titless'] = 'Медичний центр: адреса г. Харьков, м. Пушкінська. Контактні телефони, карта проїзду, графік роботи. Запишіться вже сьогодні ➾ МДЦ LUX'; #39743

$_['text_zakazat']  = 'Замовити персональну консультацію';
$_['text_zakazat_expert']  = 'Замовити персональну консультацію експерта';
$_['text_ostavte']  = 'Залиште ваші контактні дані і наш менеджер з Вами зв`яжеться найближчим часом';
$_['text_names']  = 'Ім`я:';
$_['text_telephones']  = 'Телефон:';
$_['text_messages']  = 'Ваше повідомлення:';
$_['text_zvonok']  = 'Замовити дзвінок';
