...
$_['heading_titles']  = 'Контакты | Медицинский центр: адрес, карта проезда | МДЦ LUX';
$_['heading_titless']  = 'Медицинский центр: адрес г. Харьков, м. Пушкинская. Контактные телефоны, карта проезда, график работы. Запишитесь уже сегодня ➾ МДЦ LUX';
