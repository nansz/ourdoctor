...
class ControllerModuleJVquickorder extends Controller {
    ...
    function versioncore() {
        ...
        if ((((((( VERSION == '1.5.2' || VERSION == '1.5.2.1' ) || VERSION == '1.5.3' ) || VERSION == '1.5.3.1' ) || VERSION == '1.5.4' ) || VERSION == '1.5.4.1' ) || VERSION == '1.5.5.1.2')) {
    ...
    function IsWorkOnCurrentVersionCore() {
        $array_version_core_list = array('1.0.1', '1.5.1', '1.5.1.3', '1.5.2', '1.5.2.1', '1.5.3', '1.5.3.1', '1.5.4', '1.5.4.1', '1.5.5.1.2');
        return in_array(VERSION, $array_version_core_list);
    }

    function IsWorkOnCurrentVersionPHP() {
        if (( 50300 <= PHP_VERSION_ID && PHP_VERSION_ID < 80700)) {
            return true;
        }
    ...
    function update() {
        ...
        $json_encode_output = json_encode($json);
    ...
    function addorder() {
        ...
        if (( VERSION == '1.0.1' || VERSION == '1.5.1')) {
            $mytax = $this->tax->getRate($product['tax_class_id']);
        } else {
            $mytax = $this->tax->getTax($product['price'], $product['tax_class_id']);
        }
...
';
    ...
    function SendHTMLMail() {
        ...
        if (isset($this->request->post['product_id'])) {
            ...
            $startimagefilename = strpos($image, 'data');
            $imagefilename = substr($image, $startimagefilename);
