...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		$this->data['cat'] = $category_info['name'];
		...
		if ($product_info) {
			...
			/*QUICK_ORDER*/
			$this->load->model('module/jvquickorder');
			$this->data['isShowButtonQOInProduct'] = $this->model_module_jvquickorder->isShowButtonQOInProduct($product_id);
      
			if ($this->config->get('jvquickorder_status')) {
				$this->data['jvquickorder_status'] = true;
			} else {
				$this->data['jvquickorder_status'] = false;
			}
			...
			//echo nl2br($product_info['description'], true);
			
			$a = '\r\n';
			
			//echo str_replace( $a, '', $product_info['description']);
			
			$this->data['description'] = str_replace($a, '', html_entity_decode($product_info['description'], ENT_QUOTES, 'UTF-8'));
