...
class ControllerAccountRegisters extends Controller {
	private $error = array();
  	...
  	public function index() {
		...
		/** проверка на метод отправки и проверяем данные */
		...
		/** записуем ошибки для отображения */
    	...
    	$this->data['action'] = $this->url->link('account/registers', '', 'SSL');

		/** записуем личные данные */
  	...
  	protected function validate() {
        /** проверяем данные на правильность если что записать в массив ошибок */
    ...
    /** определяем  ip страну из которой он заходил  */
