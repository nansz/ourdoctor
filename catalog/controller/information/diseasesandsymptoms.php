...
class ControllerInformationdiseasesandsymptoms extends Controller
{

    public function index()
    {

        $this->language->load('information/diseasesandsymptoms');
        ...
        if (isset($this->request->get['diseasesandsymptoms_id'])) {
            $diseasesandsymptoms_id = $this->request->get['diseasesandsymptoms_id'];
        } else {
            $diseasesandsymptoms_id = 0;
        }
        ...
        $articles_info = $this->model_catalog_diseasesandsymptoms->getArticlesStory($diseasesandsymptoms_id);
        ...
        if ($articles_info) {
            ...
            if ($this->session->data['language'] == 'ua' && $articles_info['ukr'] == '0') {
                ...
                header("Location: /ua/diseasesandsymptoms/");
                exit();
            }

            if ($this->session->data['language'] == 'en' && $articles_info['eng'] == '0') {
                header("HTTP/1.1 301 Moved Permanently");
                header("Location: /en/diseasesandsymptoms/");
                exit();
            }

            if ($this->session->data['language'] == 'ru' && $articles_info['rus'] == '0') {
                header("HTTP/1.1 301 Moved Permanently");
                header("Location: /diseasesandsymptoms/");
                exit();
            }
            ...
            $this->data['breadcrumbs'][] = array(
                'href' => $this->url->link('information/diseasesandsymptoms'),
                'text' => $this->language->get('heading_title'),
                'separator' => $this->language->get('text_separator')
            );

            $this->data['breadcrumbs'][] = array(
                'href' => $this->url->link('information/diseasesandsymptoms', 'diseasesandsymptoms_id=' . $this->request->get['diseasesandsymptoms_id']),
            ...
            $results = $this->model_catalog_diseasesandsymptoms->getProductImages($this->request->get['diseasesandsymptoms_id']);
            ...
            $this->load->model('catalog/diseasesandsymptoms');
            $staf_results = $this->model_catalog_diseasesandsymptoms->getStaffStory($articles_info['author_id']);
...
//            $this->url->link('information/staff', 'staff_id=' . $articles_info['author_id']);
            $results = $this->model_catalog_diseasesandsymptoms->getArticlesRelated($this->request->get['diseasesandsymptoms_id']);
//
              $i=0;
            foreach ($results as $result) {
                	if($i<2){
                foreach ($result as $resultz) {
                    ...
                    $this->data['article_related'][] = array(
                        'diseasesandsymptoms_id' => $resultz['diseasesandsymptoms_id'],
                        'thumb' => $image,
                        'name' => $resultz['title'],
                        'author' => $staf_results['title'],
//                        'author_href' => $this->url->link('information/staff', 'author_id=' . $resultz['author_id']),
//                        'description' => html_entity_decode($resultz['description']),
                        ...
                        'href' => $this->url->link('information/diseasesandsymptoms', 'diseasesandsymptoms_id=' . $resultz['diseasesandsymptoms_id'])
                    );
                }
                        $i++;
                    }
            ...
            $this->document->addLink($this->url->link('information/diseasesandsymptoms', 'diseasesandsymptoms_id=' . $this->request->get['diseasesandsymptoms_id']), 'canonical');
...
//            $this->config->get('articles_popup_width'), $this->config->get('articles_popup_height'));
            ...
            $this->data['articles'] = $this->url->link('information/diseasesandsymptoms');
            ...
            if ($this->data['referred'] != $this->data['refreshed']) {
                $this->model_catalog_diseasesandsymptoms->updateViewed($this->request->get['diseasesandsymptoms_id']);
            }

            if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/information/diseasesandsymptoms.tpl')) {
                $this->template = $this->config->get('config_template') . '/template/information/diseasesandsymptoms.tpl';
            } else {
                $this->template = 'default/template/information/diseasesandsymptoms.tpl';
            }
            ...
            if ($this->session->data['language'] == 'ru') {
                $articles_data = $this->model_catalog_diseasesandsymptoms->getArticlesRus($data);
                $articles_total = $this->model_catalog_diseasesandsymptoms->getTotalArticlesRus();
            } elseif ($this->session->data['language'] == 'ua') {
                $articles_data = $this->model_catalog_diseasesandsymptoms->getArticlesUkr($data);
                $articles_total = $this->model_catalog_diseasesandsymptoms->getTotalArticlesUkr();
            } elseif ($this->session->data['language'] == 'en') {
                $articles_data = $this->model_catalog_diseasesandsymptoms->getArticlesEng($data);
                $articles_total = $this->model_catalog_diseasesandsymptoms->getTotalArticlesEng();
            }
            ...
            if ($articles_data) {
                ...
                foreach ($articles_data as $result) {
                    $this->data['articles_data'][] = array(
                        'id' => $result['diseasesandsymptoms_id'],
                        'title' => $result['title'],
                ...
                $pagination->url = $this->url->link('information/diseasesandsymptoms', '&page={page}');
