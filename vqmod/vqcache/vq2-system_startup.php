...
require_once($vqmod->modCheck(DIR_SYSTEM . 'library/paginations.php'));
require_once($vqmod->modCheck(DIR_SYSTEM . 'library/paginationz.php'));
require_once($vqmod->modCheck(DIR_SYSTEM . 'library/paginationzz.php'));
