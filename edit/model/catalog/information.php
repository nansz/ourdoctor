...
class ModelCatalogInformation extends Model {
	public function addInformation($data) {
		...
		foreach ($data['information_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "information_description SET information_id = '" . (int)$information_id . "', language_id = '" . (int)$language_id . "', title = '" . $this->db->escape($value['title']) . "', videotitle = '" . $this->db->escape($value['videotitle']) . "', videoimage = '" . $this->db->escape($value['videoimage']) . "', imageone = '" . $this->db->escape($value['imageone']) . "', imagetwo = '" . $this->db->escape($value['imagetwo']) . "', description = '" . $this->db->escape($value['description']) . "', description2 = '" . $this->db->escape($value['description2']) . "', smalltext = '" . $this->db->escape($value['smalltext']) . "', video = '" . $this->db->escape($value['video']) . "', meta_keyword = '" . $this->db->escape($value['meta_keyword']) . "', meta_description = '" . $this->db->escape($value['meta_description']) . "', seo_title = '" . $this->db->escape($value['seo_title']) . "', seo_h1 = '" . $this->db->escape($value['seo_h1']) . "'");
		}
