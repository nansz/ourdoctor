      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          <table class="form">
            ...
            <tr>
              <td><?php echo "Телефон 2"; ?></td>
              <td><input type="text" name="config_fax" value="<?php echo $config_fax; ?>" /></td>
            </tr>
			<tr>
              <td><?php echo "Телефон 3"; ?></td>
              <td><input type="text" name="config_telephone3" value="<?php echo $config_telephone3; ?>" /></td>
            </tr>
			<tr>
			...
			<tr>
              <td><?php echo "Код карты Google.Maps"; ?></td>
              <td><input type="text" name="config_icq" value="<?php echo $config_icq; ?>" /></td>
            </tr>
			<tr>
              <td><?php echo "Время работы Будни"; ?></td>
              <td><input type="text" name="config_budni" value="<?php echo $config_budni; ?>" /></td>
            </tr>
			<tr>
              <td><?php echo "Время работы Суббота"; ?></td>
              <td><input type="text" name="config_subbota" value="<?php echo $config_subbota; ?>" /></td>
            </tr>
			<tr>
              <td><?php echo "Время работы Воскресенье"; ?></td>
              <td><input type="text" name="config_voskresenje" value="<?php echo $config_voskresenje; ?>" /></td>
            </tr>
			
			<tr>
              <td><?php echo "Google+ ссылка"; ?></td>
              <td><input type="text" name="config_vk" value="<?php echo $config_vk; ?>" /></td>
            </tr>
			
			<tr>
              <td><?php echo "facebook ссылка"; ?></td>
              <td><input type="text" name="config_fb" value="<?php echo $config_fb; ?>" /></td>
            </tr>
			
			<tr>
              <td><?php echo "Youtube ссылка"; ?></td>
              <td><input type="text" name="config_youtube" value="<?php echo $config_youtube; ?>" /></td>
            </tr>
			
			<tr>
              <td><?php echo "Instagram ссылка"; ?></td>
              <td><input type="text" name="config_google" value="<?php echo $config_google; ?>" /></td>
            </tr>
			
			<tr>
              <td><?php echo "Доставка на карточке товара"; ?></td>
              <td><textarea type="text" id="dostavka" name="config_dostavka"><?php echo $config_dostavka; ?></textarea></td>
            </tr>
			
			<tr>
              <td><?php echo "Оплата на карточке товара"; ?></td>
              <td><textarea type="text" id="oplata" name="config_oplata"><?php echo $config_oplata; ?></textarea></td>
            </tr>
			
			<tr>
              <td><?php echo "Гарантия на карточке товара"; ?></td>
              <td><textarea type="text" id="garantija" name="config_garantija"><?php echo $config_garantija; ?></textarea></td>
            </tr>
          </table>
        </div>
        <div id="tab-store">
...
CKEDITOR.replace('config_dostavka', {
...
CKEDITOR.replace('config_oplata', {
	filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
...
CKEDITOR.replace('config_garantija', {
	filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
