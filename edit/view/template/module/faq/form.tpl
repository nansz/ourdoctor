    ...
    <div class="content">
        ...
        <div id="tab_language">
			...
			<div id="language<?php echo $language['language_id']; ?>">
				<table class="form">
				<tr>
					<td><span class="required">*</span> <?php echo "Вопрос:"; ?></td>
				...
				<tr style="display:none;">
					...
					<td><textarea name="faq_description[<?php echo $language['language_id']; ?>][meta_description]" cols="70" rows="2"><?php echo isset($faq_description[$language['language_id']]) ? $faq_description[$language['language_id']]['meta_description'] : ''; ?></textarea></td>
				</tr>
				<tr style="display:none;">
					<td><?php echo $entry_meta_keyword; ?></td>
					<td><textarea name="faq_description[<?php echo $language['language_id']; ?>][meta_keyword]" cols="70" rows="2"><?php echo isset($faq_description[$language['language_id']]) ? $faq_description[$language['language_id']]['meta_keyword'] : ''; ?></textarea></td>
				</tr>
            <tr style="display:none;">
              ...
              <td><input type="text" name="date_added" value="<?php echo $date_added; ?>" size="12" /></td>
				...
				<tr>
					<td><span class="required">*</span> <?php echo "Ответ"; ?></td>
					<td><textarea value="test" name="faq_description[<?php echo $language['language_id']; ?>][description]" id="description<?php echo $language['language_id']; ?>"><?php echo isset($faq_description[$language['language_id']]) ? $faq_description[$language['language_id']]['description'] : ''; ?></textarea>
        ...
        <div id="tab_setting">
            ...
            <tr>
				...
				<td>
					...
					<a onclick="select_all('faq_store', '1');"><?php echo $text_select_all; ?></a> | <a onclick="select_all('faq_store', '0');"><?php echo $text_unselect_all; ?></a>
				</td>
            </tr>
            <tr>
