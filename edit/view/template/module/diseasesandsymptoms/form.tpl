...
<div id="content">
    ...
    <div class="box">
        <div class="heading">
            <h1><img src="view/image/diseasesandsymptoms.png" alt=""/> <?php echo $heading_title; ?></h1>
            <div class="buttons">
                    ...
                    <div id="language<?php echo $language['language_id']; ?>">
                        <table class="form">
                            <tr>
                                ...
                                <td><input name="diseasesandsymptoms_description[<?php echo $language['language_id']; ?>][title]"
                                           size="80"
                                           value="<?php echo isset($diseasesandsymptoms_description[$language['language_id']]) ? $diseasesandsymptoms_description[$language['language_id']]['title'] : ''; ?>"/>
                            ...
                            <tr>
                                ...
                                <td><textarea
                                            name="diseasesandsymptoms_description[<?php echo $language['language_id']; ?>][meta_title]"
                                            style="width:90%;"
                                            rows="2"><?php echo isset($diseasesandsymptoms_description[$language['language_id']]) ? $diseasesandsymptoms_description[$language['language_id']]['meta_title'] : ''; ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td><?php echo $entry_meta_description; ?></td>
                                <td><textarea
                                            name="diseasesandsymptoms_description[<?php echo $language['language_id']; ?>][meta_description]"
                                            cols="70"
                                            rows="2"><?php echo isset($diseasesandsymptoms_description[$language['language_id']]) ? $diseasesandsymptoms_description[$language['language_id']]['meta_description'] : ''; ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td><?php echo $entry_meta_keyword; ?></td>
                                <td><textarea
                                            name="diseasesandsymptoms_description[<?php echo $language['language_id']; ?>][meta_keyword]"
                                            cols="70"
                                            rows="2"><?php echo isset($diseasesandsymptoms_description[$language['language_id']]) ? $diseasesandsymptoms_description[$language['language_id']]['meta_keyword'] : ''; ?></textarea>
                                </td>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><textarea
                                            name="diseasesandsymptoms_description[<?php echo $language['language_id']; ?>][description]"
                                            id="description<?php echo $language['language_id']; ?>"><?php echo isset($diseasesandsymptoms_description[$language['language_id']]) ? $diseasesandsymptoms_description[$language['language_id']]['description'] : ''; ?></textarea>
                            ...
                            <tr>
                                <td><span class="required">*</span> <?php echo $entry_description; ?></td>
                                <td><textarea
                                            name="diseasesandsymptoms_description[<?php echo $language['language_id']; ?>][description2]"
                                            id="description2<?php echo $language['language_id']; ?>"><?php echo isset($diseasesandsymptoms_description[$language['language_id']]) ? $diseasesandsymptoms_description[$language['language_id']]['description2'] : ''; ?></textarea>
                                    <?php if (isset($error_description[$language['language_id']])) { ?>
                                    <span class="error"><?php echo $error_description[$language['language_id']]; ?></span>
                                    <?php } ?>
                                </td>
                            ...
                            <tr>
                                <td><span class="required">*</span> <?php echo $entry_description; ?></td>
                                <td><textarea
                                            name="diseasesandsymptoms_description[<?php echo $language['language_id']; ?>][description3]"
                                            id="description3<?php echo $language['language_id']; ?>"><?php echo isset($diseasesandsymptoms_description[$language['language_id']]) ? $diseasesandsymptoms_description[$language['language_id']]['description3'] : ''; ?></textarea>
                                    <?php if (isset($error_description[$language['language_id']])) { ?>
                                    <span class="error"><?php echo $error_description[$language['language_id']]; ?></span>
                                    <?php } ?>
                                </td>
                            ...
                            <td>
                                <div id="store_ids" class="scrollbox" style="width:225px;height:60px;">
                                    ...
                                    <div class="<?php echo $class; ?>">
                                        <?php if (in_array(0, $diseasesandsymptoms_store)) { ?>
                                        <input type="checkbox" name="diseasesandsymptoms_store[]" value="0" checked="checked"/>
                                        <?php echo $text_default; ?>
                                        <?php } else { ?>
                                        <input type="checkbox" name="diseasesandsymptoms_store[]" value="0"/>
                                        <?php echo $text_default; ?>
                                        <?php } ?>
                                    </div>
                                    ...
                                    <div class="<?php echo $class; ?>">
                                        <?php if (in_array($store['store_id'], $diseasesandsymptoms_store)) { ?>
                                        <input type="checkbox" name="diseasesandsymptoms_store[]"
                                ...
                                <a onclick="select_all('diseasesandsymptoms_store', '1');"><?php echo $text_select_all; ?></a> | <a
                                        onclick="select_all('diseasesandsymptoms_store', '0');"><?php echo $text_unselect_all; ?></a>
                            </td>
                        </tr>
                        <tr>
...
<script type="text/javascript"><!--
    ...
    $('input[name=\'related\']').autocomplete({
        ...
        source: function (request, response) {
            $.ajax({
                url: 'index.php?route=module/diseasesandsymptoms/autocomplete&token=<?php echo $token; ?>&filter_name=' + encodeURIComponent(request.term),
                dataType: 'json',
                success: function (json) {
                    response($.map(json, function (item) {
                        return {
