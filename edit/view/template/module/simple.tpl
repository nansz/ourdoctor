...
$(function() {
    ...
    $('input[name=simple_customer_action_register]').on('change',function(){
        if ($(this).val() == 2) {
    ...
    $('input[name=simple_customer_action_subscribe]').on('change',function(){
        if ($(this).val() == 2) {
    ...
    $('input[name=simple_registration_subscribe]').on('change',function(){
        if ($(this).val() == 2) {
    ...
    $('tr.row_values textarea').on('keyup', function() {
        init_values($(this));
    });
