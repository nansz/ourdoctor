        ...
        <div id="tab-data">
          <table class="form">
            <tr style="display:none;">
              ...
              <td><input type="text" name="model" value="<?php if($model) { echo $model; } else echo "-"; ?>" />
                <?php if ($error_model) { ?>
            ...
            <tr style="display:none;">
              ...
              <td><input type="text" name="location1" value="<?php echo $location; ?>" /></td>
            </tr>
			<tr style="display:none;">
              <td><?php echo $entry_location; ?></td>
              <td>
					<select name="location">
						  <option value="0"><?php echo "Выберите Партнера"; ?></option>

						  <?php foreach ($partners as $p) { ?>
							<?php if ($p['title'] == $location) { ?>
								<option value="<?php echo $p['title']; ?>" selected="selected"><?php echo $p['title']; ?></option>
							<?php } else { ?>
								<option value="<?php echo $p['title']; ?>"><?php echo $p['title']; ?></option>
							<?php } ?>
						  <?php } ?>
