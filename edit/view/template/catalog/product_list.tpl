...
<div id="content">
    ...
    <div class="box">
        <div class="heading">
            ...
            <div class="buttons"><a onclick="location = '<?php echo $insert; ?>'"
                                    class="button"><?php echo $button_insert; ?></a><a
                        onclick="$('#form').attr('action', '<?php echo $copy; ?>'); $('#form').submit();"
                        class="button"><?php echo $button_copy; ?></a><a onclick="$('form').submit();"
                ...
                <table class="list">
                    ...
                    <tr id="head">
                        ...
                        <td class="left"><?php if ($sort == 'p.price') { ?>
                            ...
                            <?php } ?></td>
                        <td class="right" style="width:30px;"><?php if ($sort == 'p.quantity') { ?>
                    ...
                    <tr class="filter">
                        ...
                        <td style="display:none;"><select name="filter_manufacturer_id" style="width: 100px;">
                                <option value="*"></option>
                                <option value="null">-</option>
                                <?php foreach($manufacturers as $manufacturer) { ?>
                                <option value="<?php echo $manufacturer['manufacturer_id'] ?>"
                                <?php if($filter_manufacturer_id == $manufacturer['manufacturer_id']) echo 'selected="selected"'; ?>
                        ...
                        <td style="display:none;"><input type="text" name="filter_model"
                                                         value="<?php echo $filter_model; ?>"/></td>
                        <td align="left"><input type="text" name="filter_price" value="<?php echo $filter_price; ?>"
                                                size="8"/></td>
                        <td align="right"><input type="text" name="filter_quantity"
                                                 value="<?php echo $filter_quantity; ?>" size="3"
                        ...
                        <td align="right"><a onclick="clear_filter();" class="button"><?php echo $button_clear; ?></a>
                        </td>
                    </tr>
                    <?php if ($products) { ?>
                    ...
                    <tr>
                        ...
                        <td class="left"><?php foreach ($product['category'] as $cat) echo $cat['name'] . '<br />'; ?>
                        </td>
                        <td class="left" style="display:none;"><?php echo $product['manufacturer']; ?></td>
...
<div>
    ...
    <script type="text/javascript"><!--
        function filter() {
            ...
            var category_id = $('select[name="filter_category_id"]').val();
            ...
            var manufacturer_id = $('select[name=\'filter_manufacturer_id\']').val();
