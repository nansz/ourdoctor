        ...
        <div id="tab-general">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
			  ...
			  <tr>
                <td><?php echo "Короткое описание для главной страницы"; ?></td>
                <td><textarea name="category_description[<?php echo $language['language_id']; ?>][smalltext]" id="description2<?php echo $language['language_id']; ?>"><?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['smalltext'] : ''; ?></textarea></td>
              </tr>
              <tr>
        ...
        <div id="tab-data">
          <table class="form">
			...
			<tr>
              ...
              <td valign="top"><div class="image"><img src="<?php echo $thumb2; ?>" alt="" id="thumb2" />
			...
			<tr>
              <td><?php echo "Изображение 3"; ?></td>
              <td valign="top"><div class="image"><img src="<?php echo $thumb3; ?>" alt="" id="thumb3" />
			...
			<tr>
              <td><?php echo "Изображение 4"; ?></td>
              <td valign="top"><div class="image"><img src="<?php echo $thumb4; ?>" alt="" id="thumb4" />
			...
			<tr>
              <td><?php echo "Изображение 5"; ?></td>
              <td valign="top"><div class="image"><img src="<?php echo $thumb5 ?>" alt="" id="thumb5" />
			...
			<tr>
              <td><?php echo "Изображение 6"; ?></td>
              <td valign="top"><div class="image"><img src="<?php echo $thumb6; ?>" alt="" id="thumb6" />
                  <input type="hidden" name="image6" value="<?php echo $image6; ?>" id="image6" />
                  <br />
                  <a onclick="image_upload('image6', 'thumb6');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb6').attr('src', '<?php echo $no_image; ?>'); $('#image6').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
            </tr>
			<tr>
              <td><?php echo "Изображение 7"; ?></td>
              <td valign="top"><div class="image"><img src="<?php echo $thumb7; ?>" alt="" id="thumb7" />
                  <input type="hidden" name="image7" value="<?php echo $image7; ?>" id="image7" />
                  <br />
                  <a onclick="image_upload('image7', 'thumb7');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb7').attr('src', '<?php echo $no_image; ?>'); $('#image7').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
            </tr>
			<!-- *************** -->
