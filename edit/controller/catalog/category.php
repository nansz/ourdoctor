...
class ControllerCatalogCategory extends Controller { 
	...
	protected function getForm() {
		...
		if (isset($this->request->post['image2'])) {
			...
			$this->data['image2'] = $category_info['image2'];
		} else {
			$this->data['image2'] = '';
		}
		...
		if (isset($this->request->post['image3'])) {
			...
			$this->data['image3'] = $category_info['image3'];
		} else {
			$this->data['image3'] = '';
		}
		...
		if (isset($this->request->post['image4'])) {
			...
			$this->data['image4'] = $category_info['image4'];
		} else {
			$this->data['image4'] = '';
		}
		...
		if (isset($this->request->post['image5'])) {
			...
			$this->data['image5'] = $category_info['image5'];
		} else {
			$this->data['image5'] = '';
		}
		
		if (isset($this->request->post['image6'])) {
			$this->data['image3'] = $this->request->post['image6'];
		} elseif (!empty($category_info)) {
			$this->data['image6'] = $category_info['image6'];
		} else {
			$this->data['image6'] = '';
		}
		...
		if (isset($this->request->post['image7'])) {
			...
			$this->data['image7'] = $category_info['image7'];
		} else {
			$this->data['image7'] = '';
		}
		...
		if (isset($this->request->post['image2']) && file_exists(DIR_IMAGE . $this->request->post['image2'])) {
			...
			$this->data['thumb2'] = $this->model_tool_image->resize($category_info['image2'], 100, 100);
		} else {
		...
		} elseif (!empty($category_info) && $category_info['image3'] && file_exists(DIR_IMAGE . $category_info['image3'])) {
			$this->data['thumb3'] = $this->model_tool_image->resize($category_info['image3'], 100, 100);
		} else {
		...
		} elseif (!empty($category_info) && $category_info['image4'] && file_exists(DIR_IMAGE . $category_info['image4'])) {
			$this->data['thumb4'] = $this->model_tool_image->resize($category_info['image4'], 100, 100);
		} else {
		...
		} elseif (!empty($category_info) && $category_info['image5'] && file_exists(DIR_IMAGE . $category_info['image5'])) {
			$this->data['thumb5'] = $this->model_tool_image->resize($category_info['image5'], 100, 100);
		} else {
		...
		} elseif (!empty($category_info) && $category_info['image6'] && file_exists(DIR_IMAGE . $category_info['image6'])) {
			$this->data['thumb6'] = $this->model_tool_image->resize($category_info['image6'], 100, 100);
		} else {
		...
		} elseif (!empty($category_info) && $category_info['image7'] && file_exists(DIR_IMAGE . $category_info['image7'])) {
			$this->data['thumb7'] = $this->model_tool_image->resize($category_info['image7'], 100, 100);
		} else {
