...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_email2'])) {
			$this->data['config_email2'] = $this->request->post['config_email2'];
		} else {
			$this->data['config_email2'] = $this->config->get('config_email2');
		}
		...
		if (isset($this->request->post['config_budni'])) {
			$this->data['config_budni'] = $this->request->post['config_budni'];
		} else {
			$this->data['config_budni'] = $this->config->get('config_budni');
		}
		
		if (isset($this->request->post['config_subbota'])) {
			$this->data['config_subbota'] = $this->request->post['config_subbota'];
		} else {
			$this->data['config_subbota'] = $this->config->get('config_subbota');
		}
		
		if (isset($this->request->post['config_voskresenje'])) {
			$this->data['config_voskresenje'] = $this->request->post['config_voskresenje'];
		} else {
			$this->data['config_voskresenje'] = $this->config->get('config_voskresenje');
		}
		...
		if (isset($this->request->post['config_dostavka'])) {
			$this->data['config_dostavka'] = $this->request->post['config_dostavka'];
		} else {
			$this->data['config_dostavka'] = $this->config->get('config_dostavka');
		}
		
		if (isset($this->request->post['config_oplata'])) {
			$this->data['config_oplata'] = $this->request->post['config_oplata'];
		} else {
			$this->data['config_oplata'] = $this->config->get('config_oplata');
		}
		
		if (isset($this->request->post['config_garantija'])) {
			$this->data['config_garantija'] = $this->request->post['config_garantija'];
		} else {
			$this->data['config_garantija'] = $this->config->get('config_garantija');
		}
