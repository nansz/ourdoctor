...
class ControllerModuleArticles extends Controller {
	...
	private function getForm() { 
        ...
        if (isset($this->request->post['product_related'])) {
            ...
            $products = $this->model_catalog_articles->getProductRelated($this->request->get['articles_id']);
        ...
        foreach ($products as $product_id) {
            $related_info = $this->model_catalog_articles->getProduct($product_id['articles_id']);
            if ($related_info) {
                $this->data['product_related'][] = array(
                    'product_id' => $related_info['articles_id'],
         ...
         $staff_info=  $this->model_catalog_articles->getStaff();
        ...
        if (isset($this->request->post['product_image'])) {
            ...
            $product_images = $this->model_catalog_articles->getProductImages($this->request->get['articles_id']);
        } else {
...
//		}
        ...
        if (isset($this->request->post['articles_description2'])) {
            $this->data['articles_description2'] = $this->request->post['articles_description2'];
        } elseif (isset($this->request->get['articles_id'])) {
            $this->data['articles_description2'] = $this->model_catalog_articles->getArticlesDescriptions($this->request->get['articles_id']);
        } else {
            $this->data['articles_description2'] = array();
        }
        if (isset($this->request->post['articles_description3'])) {
            $this->data['articles_description3'] = $this->request->post['articles_description3'];
        } elseif (isset($this->request->get['articles_id'])) {
            $this->data['articles_description3'] = $this->model_catalog_articles->getArticlesDescriptions($this->request->get['articles_id']);
        } else {
            $this->data['articles_description3'] = array();
        }
		...
		} elseif (isset($articles_info['date_added'])) {
		...
		elseif (!empty($articles_info['keyword']))
		{
			$this->data['keyword'] = utf8_strtolower($articles_info['keyword']);
		}
		else
		{
			if (!empty($this->data['articles_description'][1]['title']))
			{
				$this->data['keyword'] = utf8_strtolower(translitIt($this->data['articles_description'][1]['title']));
			}
			else
			{
				$this->data['keyword'] = '';
        ...
        if (isset($this->request->post['hrefwebsite'])) {
            ...
            $this->data['hrefwebsite'] = $articles_info['hrefwebsite'];
        } else {
        ...
        if (isset($this->request->post['author'])) {
            ...
            $this->data['author'] = $articles_info['author'];
        } else {
            $this->data['author'] = '';
        }
		...
		if (isset($this->request->post['rus'])) {
			...
			$this->data['rus'] = $articles_info['rus'];
		} else {
			$this->data['rus'] = 0;
		}
		...
		if (isset($this->request->post['ukr'])) {
			...
			$this->data['ukr'] = $articles_info['ukr'];
		} else {
			$this->data['ukr'] = 0;
		}
		...
		if (isset($this->request->post['eng'])) {
			...
			$this->data['eng'] = $articles_info['eng'];
		} else {
			$this->data['eng'] = 0;
		}
...
//		}
    ...
    public function autocomplete() {
        ...
        if (isset($this->request->get['filter_name']) || isset($this->request->get['filter_model']) || isset($this->request->get['filter_category_id'])) {
            ...
            $results = $this->model_catalog_articles->getProducts($data);
