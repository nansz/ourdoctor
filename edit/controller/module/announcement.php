...
class ControllerModuleannouncement extends Controller {
	private $error = array();
	private $_name = 'announcement';
	...
	public function index() {
        ...
        $this->load->language('module/announcement' );

        $this->data[$this->_name . '_version'] = $this->_version;
	
		$this->load->model('catalog/announcement');
		
		$this->model_catalog_announcement->checkannouncement();
	...
	public function insert() { 
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validateForm())) {
			...
			$this->model_catalog_announcement->addannouncement($this->request->post);

			$this->session->data['success'] = $this->language->get('text_success');

			$this->redirect($this->url->link('module/announcement/listing', 'token=' . $this->session->data['token'], 'SSL'));
		}
	...
	public function update() { 
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validateForm())) {
			...
			$this->model_catalog_announcement->editannouncement($this->request->get['announcement_id'], $this->request->post);
	...
	public function delete() { 
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $announcement_id) {
				$this->model_catalog_announcement->deleteannouncement($announcement_id);
			}
	...
	private function getModule() { 
		...
		$this->data['entry_announcementpage_thumb'] = $this->language->get('entry_announcementpage_thumb');
		$this->data['entry_announcementpage_popup'] = $this->language->get('entry_announcementpage_popup');
		$this->data['entry_announcementpage_addthis'] = $this->language->get('entry_announcementpage_addthis');
		...
		$this->data['button_announcement'] = $this->language->get('button_announcement');
		...
		if (isset($this->error['announcementpage_thumb'])) {
			$this->data['error_announcementpage_thumb'] = $this->error['announcementpage_thumb'];
		} else {
			$this->data['error_announcementpage_thumb'] = '';
		}
	
		if (isset($this->error['announcementpage_popup'])) {
			$this->data['error_announcementpage_popup'] = $this->error['announcementpage_popup'];
		} else {
			$this->data['error_announcementpage_popup'] = '';
		}
		...
		if (isset($this->request->post[$this->_name . '_announcementpage_addthis'])) {
			$this->data[$this->_name . '_announcementpage_addthis'] = $this->request->post[$this->_name . '_announcementpage_addthis'];
		} else {
			$this->data[$this->_name . '_announcementpage_addthis'] = $this->config->get($this->_name . '_announcementpage_addthis');
		}
		...
		$this->template = 'module/announcement.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	private function getList() {
		...
		$this->data['breadcrumbs'][] = array(
			'href'      => $this->url->link('module/announcement/listing', 'token=' . $this->session->data['token'], 'SSL'),
			'text'      => $this->language->get('heading_title'),
		);
	
		$this->data['module'] = $this->url->link('module/announcement', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['insert'] = $this->url->link('module/announcement/insert', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['delete'] = $this->url->link('module/announcement/delete', 'token=' . $this->session->data['token'], 'SSL');
	
		$this->data['totalannouncement'] = $this->model_catalog_announcement->getTotalannouncement();
	
		$this->load->model('tool/image');
	
		$this->data['announcement'] = array();
	
		$results = $this->model_catalog_announcement->getannouncement();
    	...
    	foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('module/announcement/update', 'token=' . $this->session->data['token'] . '&announcement_id=' . $result['announcement_id'], 'SSL')
			);
		...
		$this->template = 'module/announcement/list.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	private function getForm() { 
        ...
        if (isset($this->request->post['product_related'])) {
            ...
            $products = $this->model_catalog_announcement->getProductRelated($this->request->get['announcement_id']);
        } else {
            $products = array();
        }
        ...
        foreach ($products as $product_id) {
            $related_info = $this->model_catalog_announcement->getProduct($product_id['announcement_id']);
            if ($related_info) {
                $this->data['product_related'][] = array(
                    'product_id' => $related_info['announcement_id'],
         ...
         $staff_info=  $this->model_catalog_announcement->getStaff();
        ...
        if (isset($this->request->post['product_image'])) {
            ...
            $product_images = $this->model_catalog_announcement->getProductImages($this->request->get['announcement_id']);
        } else {
...
//		}
		...
		if (!isset($this->request->get['announcement_id'])) {
			$this->data['action'] = $this->url->link('module/announcement/insert', 'token=' . $this->session->data['token'], 'SSL');
		} else {
			$this->data['action'] = $this->url->link('module/announcement/update', 'token=' . $this->session->data['token'] . '&announcement_id=' . $this->request->get['announcement_id'], 'SSL');
		}
	
		$this->data['cancel'] = $this->url->link('module/announcement/listing', 'token=' . $this->session->data['token'], 'SSL');
	
		if ((isset($this->request->get['announcement_id'])) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$announcement_info = $this->model_catalog_announcement->getannouncementStory($this->request->get['announcement_id']);
		}
		$this->load->model('localisation/language');
		...
		if (isset($this->request->post['announcement_description'])) {
			$this->data['announcement_description'] = $this->request->post['announcement_description'];
		} elseif (isset($this->request->get['announcement_id'])) {
			$this->data['announcement_description'] = $this->model_catalog_announcement->getannouncementDescriptions($this->request->get['announcement_id']);
		} else {
			$this->data['announcement_description'] = array();
		}
		
		if (isset($this->request->post['meta_keyword'])) {
			$this->data['meta_keyword'] = $this->request->post['meta_keyword'];
		} elseif (isset($this->request->get['announcement_id'])) {
			$this->data['meta_keyword'] = $this->model_catalog_announcement->getannouncementDescriptions($this->request->get['announcement_id']);
		} else {
		...
		} elseif (isset($announcement_info['date_added'])) {
			$this->data['date_added'] = $announcement_info['date_added'];
		} else {
		...
		if (isset($this->request->post['announcement_store'])) {
			$this->data['announcement_store'] = $this->request->post['announcement_store'];
		} elseif (isset($announcement_info)) {
			$this->data['announcement_store'] = $this->model_catalog_announcement->getannouncementStores($this->request->get['announcement_id']);
		} else {
			$this->data['announcement_store'] = array(0);
		}
		...
		elseif (!empty($announcement_info['keyword']))
		{
			$this->data['keyword'] = utf8_strtolower($announcement_info['keyword']);
		}
		else
		{
			if (!empty($this->data['announcement_description'][1]['title']))
			{
				$this->data['keyword'] = utf8_strtolower(translitIt($this->data['announcement_description'][1]['title']));
			}
			else
			{
				$this->data['keyword'] = '';
  ...
  if (isset($this->request->post['hrefwebsite'])) {
      ...
      $this->data['hrefwebsite'] = $announcement_info['hrefwebsite'];
  } else {
      $this->data['hrefwebsite'] = '';
        ...
        if (isset($this->request->post['author'])) {
            ...
            $this->data['author'] = $announcement_info['author'];
        } else {
            $this->data['author'] = '';
        }
        if (isset($this->request->post['author_id'])) {
            ...
            $this->data['author_id'] = $announcement_info['author_id'];
        } else {
            $this->data['author_id'] = '';
        }
		...
		if (isset($this->request->post['status'])) {
			...
			$this->data['status'] = $announcement_info['status'];
		} else {
			$this->data['status'] = '';
		}
		...
		if (isset($this->request->post['rus'])) {
			...
			$this->data['rus'] = $announcement_info['rus'];
		} else {
			$this->data['rus'] = 0;
		}
		...
		if (isset($this->request->post['ukr'])) {
			...
			$this->data['ukr'] = $announcement_info['ukr'];
		} else {
			$this->data['ukr'] = 0;
		}
		...
		if (isset($this->request->post['eng'])) {
			...
			$this->data['eng'] = $announcement_info['eng'];
		} else {
			$this->data['eng'] = 0;
		}
		...
		if (isset($this->request->post['image'])) {
			...
			$this->data['image'] = $announcement_info['image'];
		} else {
			$this->data['image'] = '';
		}
		...
		} elseif (!empty($announcement_info) && $announcement_info['image'] && file_exists(DIR_IMAGE . $announcement_info['image'])) {
			$this->data['thumb'] = $this->model_tool_image->resize($announcement_info['image'], 100, 100);
		} else {
			$this->data['thumb'] = $this->model_tool_image->resize('no_image.jpg', 100, 100);
		}
	
		$this->template = 'module/announcement/form.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	private function validate() {
		if (!$this->user->hasPermission('modify', 'module/announcement')) {
			$this->error['warning'] = $this->language->get('error_permission');
		}
	
		if (!$this->request->post['announcement_headline_chars']) {
			$this->error['numchars'] = $this->language->get('error_numchars');
		}
	
		if (!$this->request->post['announcement_thumb_width'] || !$this->request->post['announcement_thumb_height']) {
			$this->error['announcementpage_thumb'] = $this->language->get('error_announcementpage_thumb');
		}
	
		if (!$this->request->post['announcement_popup_width'] || !$this->request->post['announcement_popup_height']) {
			$this->error['announcementpage_popup'] = $this->language->get('error_announcementpage_popup');
		}
    ...
    public function autocomplete() {
        ...
        if (isset($this->request->get['filter_name']) || isset($this->request->get['filter_model']) || isset($this->request->get['filter_category_id'])) {
            ...
            $results = $this->model_catalog_announcement->getProducts($data);
            ...
            foreach ($results as $result) {
                ...
                $json[] = array(
                    'product_id' => $result['announcement_id'],
	...
	public function install() { 
		...
		$this->db->query("CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "announcement` (`announcement_id` int(11) NOT NULL auto_increment, `status` int(1) NOT NULL default '0',`author` VARCHAR(150) NOT, `author_id` INT(10) NOT NULL `image` VARCHAR(255) COLLATE utf8_general_ci default NULL, `image_size` int(1) NOT NULL default '0', `date_added` date default NULL, `viewed` int(5) NOT NULL DEFAULT '0', PRIMARY KEY (`announcement_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci");
		//create announcement description table
		$this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "announcement_description`");
		$this->db->query("CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "announcement_description` (`announcement_id` int(11) NOT NULL default '0', `language_id` int(11) NOT NULL default '0', `title` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL, `meta_description` VARCHAR(255) COLLATE utf8_general_ci NOT NULL, `description` TEXT CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL, `description2` TEXT CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL, `description3` TEXT CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL `meta_keyword` varchar(255) COLLATE utf8_general_ci NOT NULL, PRIMARY KEY (`announcement_id`,`language_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci");
		//create announcement store table
		$this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "announcement_to_store`");
		$this->db->query("CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "announcement_to_store` (`announcement_id` int(11) NOT NULL, `store_id` int(11) NOT NULL, PRIMARY KEY (`announcement_id`, `store_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci");
    }
	...
	public function uninstall() { 
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "url_alias WHERE `query` LIKE 'announcement_id=%'");
    }
}
?>